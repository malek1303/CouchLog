            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <span className="font-bold" style={{ color: 'hsl(var(--color-brand))' }}>OS:</span> Arch Linux (I use Arch, btw 🐧)<br />
                  <span className="font-bold" style={{ color: 'hsl(var(--color-accent))' }}>Main Focus:</span> Embedded Systems & AVR Microcontrollers<br />
                  <span className="font-bold" style={{ color: 'hsl(var(--color-success))' }}>Community:</span> Head of the Embedded Systems Committee at IEEE MUST SB<br />
                  <span className="font-bold" style={{ color: 'hsl(var(--color-warning))' }}>Current Dev:</span> Atmega32 Drivers
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2.5">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'hsl(var(--color-brand))' }} />
                <span className="text-xs font-medium text-subtle">Bare-metal C & AVR Drivers</span>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'hsl(var(--color-accent))' }} />
                <span className="text-xs font-medium text-subtle">PCB Design & MC Interface</span>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'hsl(var(--color-success))' }} />
